...
public class PersonController {
    ...
    @Operation(summary = "Register a Persons in the database", description = "Register a Person object in the database. For registration fill all Persons object information with name, email and birth.", tags = {
        "Person" })
        @ApiResponses({
    ...
    @Operation(summary = "Retrieve all Persons in the database", description = "Get all Person objects in the database. The response is all Persons object with id, name, email and birth.", tags = {
        "Person" })
        @ApiResponses({
            @ApiResponse(responseCode = "200", content = {
                    @Content(schema = @Schema(implementation = Person.class), mediaType = "application/json") }),
    ...
    @Operation(summary = "Retrieve a Person by Name", description = "Get a Person object by specifying its Name. The response is Person object with id, name, email and birth.", tags = {
        "Person" })
    @ApiResponses({
        @ApiResponse(responseCode = "200", content = {
                @Content(schema = @Schema(implementation = Person.class), mediaType = "application/json") }),
    ...
    @Operation(summary = "Delete a Person by Id", description = "Delete a Person object by specifying its id.", tags = {
        "Person" })
    @ApiResponses({
        @ApiResponse(responseCode = "200", content = {
                @Content(schema = @Schema(implementation = Person.class), mediaType = "application/json") }),
    ...
    @Operation(summary = "Update a Person by Id", description = "Update a Person object by specifying its id. The response is Person object with the updated id, name, email and birth.", tags = {
        "Person" })
    @ApiResponses({
            @ApiResponse(responseCode = "200", content = {
                @Content(schema = @Schema(implementation = Person.class), mediaType = "application/json") }),
